...
namespace Microsoft.Data.SQLite.Utilities
{
    internal static class NativeLibraryLoader
    {
        ...
        public static void Load(string dllName)
        {
            ...
            var assembly = typeof(NativeLibraryLoader).GetTypeInfo().Assembly;

            try
            {
                if (TryLoadUnderKRuntime(assembly, dllName))
                    return;
            }
        ...
        private static bool TryLoadUnderKRuntime(Assembly assembly, string dllName)
        {
            ...
            {
                var library = libraryManager.GetLibraryInformation(assembly.GetName().Name);
